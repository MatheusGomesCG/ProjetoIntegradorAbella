...
import static br.com.unifacisa.desafio.domain.TransactionAsserts.*;
...
class TransactionResourceIT {
    ...
    void partialUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.amount(UPDATED_AMOUNT).transactionType(UPDATED_TRANSACTION_TYPE).description(UPDATED_DESCRIPTION);
