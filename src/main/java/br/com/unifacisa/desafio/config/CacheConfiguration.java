package br.com.unifacisa.desafio.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.unifacisa.desafio.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.unifacisa.desafio.repository.UserRepository.USERS_BY_EMAIL_CACHE);
