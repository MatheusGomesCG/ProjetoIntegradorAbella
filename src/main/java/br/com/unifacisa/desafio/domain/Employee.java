...
public class Employee implements Serializable {
    ...
    public void setAccounts(Set<AccountUser> accountUsers) {
        if (this.accounts != null) {
            this.accounts.forEach(i -> i.setOwner(null));
        }
        if (accountUsers != null) {
            accountUsers.forEach(i -> i.setOwner(this));
        }
        this.accounts = accountUsers;
    }

    public Employee accounts(Set<AccountUser> accountUsers) {
        this.setAccounts(accountUsers);
        return this;
    }

    public Employee addAccount(AccountUser accountUser) {
        this.accounts.add(accountUser);
        accountUser.setOwner(this);
        return this;
    }

    public Employee removeAccount(AccountUser accountUser) {
        this.accounts.remove(accountUser);
